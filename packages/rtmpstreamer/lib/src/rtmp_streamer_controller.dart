...
class RtmpStreamer {
  ...
  static Stream<RtmpStreamerEvent> get events {
    _ensureListening();
  ...
  static Future<bool> startStream(String url) async {
    return await _invokeBool('startStream', {'url': url});
  }

  static Future<void> updateStreamSettings(RtmpStreamSettings settings) {
    return _channel.invokeMethod<void>('updateStreamSettings', settings.toJson());
  }
  ...
  static Future<RtmpStreamerState> getState() async {
  ...
  static void _ensureListening() {
    ...
    _channel.setMethodCallHandler((call) async {
      ...
      _events.add(RtmpStreamerEvent.fromJson(args));
      return null;
    });
  }
